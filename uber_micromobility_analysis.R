...
table_s1<- matrix(nrow = 5,ncol = 10, dimnames = list(c("Effect Size","SE", "p-value", "F-stat", "n"),
                                                      c("1 day","2 days", "3 days", "4 days", "5 days", "10 days", "15 days", "20 days", "25 days", "28 days")))

table_s1[1,] <- c(round(coeffs[1],3), round(coeffs[2],3), round(coeffs[3],3), round(coeffs[4],3), round(coeffs[5],3), round(coeffs[10],3), round(coeffs[15],3), round(coeffs[20],3), round(coeffs[25],3), round(coeffs[28],3))
table_s1[2,] <- c(round(se[1],3), round(se[2],3), round(se[3],3), round(se[4],3), round(se[5],3), round(se[10],3), round(se[15],3), round(se[20],3), round(se[25],3), round(se[28],3))
table_s1[3,] <- c(round(p[1],3), round(p[2],3), round(p[3],3), round(p[4],3), round(p[5],3), round(p[10],3), round(p[15],3), round(p[20],3), round(p[25],3), round(p[28],3))
table_s1[4,] <- c(f[1], f[2], f[3], f[4], f[5], f[10], f[15], f[20], f[25], f[28])
table_s1[5,] <- c(observations[1], observations[2], observations[3], observations[4], observations[5], observations[10], observations[15], observations[20], observations[25], observations[28])
...
table_s2[1,] <- c(round(coeffs_marta[1],3), round(coeffs_marta[2],3), round(coeffs_marta[3],3), round(coeffs_marta[4],3), round(coeffs_marta[5],3), round(coeffs_marta[10],3), round(coeffs_marta[15],3), round(coeffs_marta[20],3), round(coeffs_marta[25],3), round(coeffs_marta[30],3), round(coeffs_marta[35],3), round(coeffs_marta[40],3), round(coeffs_marta[44],3))
table_s2[2,] <- c(round(se_marta[1],3), round(se_marta[2],3), round(se_marta[3],3), round(se_marta[4],3), round(se_marta[5],3), round(se_marta[10],3), round(se_marta[15],3), round(se_marta[20],3), round(se_marta[25],3), round(se_marta[30],3), round(se_marta[35],3), round(se_marta[40],3), round(se_marta[44],3))
table_s2[3,] <- c(round(p_marta[1],3), round(p_marta[2],3), round(p_marta[3],3), round(p_marta[4],3), round(p_marta[5],3), round(p_marta[10],3), round(p_marta[15],3), round(p_marta[20],3), round(p_marta[25],3), round(p_marta[30],3), round(p_marta[35],3), round(p_marta[40],3), round(p_marta[44],3))
table_s2[4,] <- c(f_marta[1], f_marta[2], f_marta[3], f_marta[4], f_marta[5], f_marta[10], f_marta[15], f_marta[20], f_marta[25], f_marta[30], f_marta[35], f_marta[40], f_marta[44])
table_s2[5,] <- c(observations_marta[1], observations_marta[2], observations_marta[3], observations_marta[4], observations_marta[5], observations_marta[10], observations_marta[15], observations_marta[20], observations_marta[25], observations_marta[30], observations_marta[35], observations_marta[40], observations_marta[44])
